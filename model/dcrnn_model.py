...
class DCRNNModel(object):
    def __init__(self, is_training, batch_size, **model_kwargs):
        ...
        #self._adj_mx = tf.sparse_placeholder(tf.float32, shape=(num_nodes, num_nodes), name='adj_mx')
        self._adj_mx = tf.sparse_placeholder(tf.float32, name='adj_mx')
        ...
        cell = DCGRUCell(rnn_units, self._adj_mx, max_diffusion_step=max_diffusion_step, num_nodes=num_nodes, filter_type=filter_type)
